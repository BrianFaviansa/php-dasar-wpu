    ...
    <div class="container w-full mx-auto m-8">
        ...
        <div class="text-center mt-8 flex justify-center flex-wrap w-full gap-4">
            ...
            <form class="" action="" method="post">
                <input id="keyword" class="p-1 text-sm border rounded-md border-black border-solid" type="text" name="keyword" id="" size="30" autofocus placeholder="Search....." autocomplete="off">
